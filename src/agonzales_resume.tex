...
\begin{description} \itemsep1pt \parskip0pt \parsep0pt
  \item \twittericon {\largeheaderfont Senior Data Scientist, Twitter } \hfill
    ...
    Worked on the Health data science team, which focused on on anti-abuse,
    spam, fake account, and misinformation problems at Twitter.
    ...
    \item Served as a technical lead and provided process improvement,
      ...
      Mentored colleagues. Reviewed work for the greater Health data science
      team
    \item Build and served as the technical lead for data science
      effectiveness, a virtual team that develops tooling, education, processes, and
      relationships with peer teams to make doing data science at Twitter
      better for all.
