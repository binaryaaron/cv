...
\begin{description}
  \item {\largeheaderfont Data Scientist Intern, TripAdvisor} \hfill
    ...
    \begin{itemize} \itemsep1pt \parskip0pt \parsep0pt
      ...
      \item Feature generation for part 2 included computer-vision
      ...
      \item Provided assistance to a SEM problem using Word2Vec to
            generate features for a regression task.
    \\*
    \end{itemize}
