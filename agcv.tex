...
\header{aaron}{gonzales}{} % Your name and current job title/field % removed title
...
\href{http://lnkd.in/b8kfQSe}{Linked\faLinkedin}
%\section{languages}
...
~
\section{about}
I am a scientifically-minded analyst with a penchant for finding creative, effective solutions to complex problems.
I am looking for a graduate program to bolster my expertise to find those solutions.
\end{aside}
...
Analysis included data munging, Kaplan-Meier estimates, and Cox Proportional Hazard modeling
in \textbf{R}.}
\end {entrylist}
   ...
   \item[\textbf{\textit{software packages and operating systems}}] \hfill \\
	 %\begin{description} \itemsep1pt \parskip0pt \parsep0pt
	   ...
	   %\item[specialized] \hfill \\
	    \textbf{Specialized} \\
	    %Adobe Illustrator, Adobe InDesign, Adobe Photoshop, Amira, ImageJ, MIPAV, \textbf{SPM8}, \textbf{FSL}, \textbf{NiftyReg}, MetaMorph 
...
\begin{description}
   ...
   \item[\textbf{\textit{psychology}}] \hfill \\  
	 Neuroimaging, Neuroanatomy, Research Methods 
...
%Powerlifting 
%\begin{itemize}
%\item 2013 Natural Athlete Strength Association (NASA) Powerlifting Meet (September): 1st Place, Powerlifting, 81kg class
%; 1st place, Powersports, 81kg class ---- comment by julia
%\item NASA New Mexico State Record: Power Clean (set in September 2013)
%\end{itemize}
