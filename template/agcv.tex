...
%    {\smallheaderfont summary:} \\*
%    RA in a neuroscience research group ran by Julia Stephen, PhD. Contributed to
%    a study investigating multi-sensory integration in
%    patients with schizophrenia and healthy normal volunteers. \\*
%    {\smallheaderfont Duties:} \\*
...
%    small programs and scripts to automate analysis tasks, data analysis.  \\*
\end{description}
%\newpage
%------------------------------------------------
...
\begin{description}
 %\item[\textbf{\emph{computer science}}] \hfill \\
  \item \textbf{Data Mining } \\*
    ...
    dirichlet allocation of 50 million captured tweets to forecast economic
    movements. \hfill
